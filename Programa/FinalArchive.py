import pandas as pd
import gzip
from functions.columns_file import *
...
df_aux['UVBw_Avg'] = df_aux['UVBw_Avg'].replace(-999, -99.9)
df_aux['UVBw_Min'] = df_aux['UVBw_Min'].replace(-999, -99.9)
df_aux['UVBw_Max'] = df_aux['UVBw_Max'].replace(-999, -99.9)
...
def CreateFinalArchive(df,path_origin=r"..\00 bsrn\fijo.dat",path_destination="Final_Example.dat"):
    ...
    if len(str(mounth_))==1:
        lines[1]=" 83" + "  " + mounth_ + " 20" + base_sql[-2:] + "  2" + "\n"
