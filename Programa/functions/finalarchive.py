...
rounds=dict(round_int=["GLOBAL_Avg","GLOBAL_Min","GLOBAL_Max","DIRECT_Avg","DIRECT_Min","DIRECT_Max","DIFFUSE_Avg",
           ...
           round_float1=["GLOBAL_Std","DIRECT_Std","DIFFUSE_Std","DOWNWARD_Std","AIR_TEMPERATURE_Avg",
                         "RELATIVE_HUMIDITY_Avg","UPWARD_SW_Std","UPWARD_LW_Std","UVBw_Avg","UVBw_Std","UVBw_Min","UVBw_Max",
...
options=dict(C0100=["day","minute","GLOBAL_Avg","GLOBAL_Std","GLOBAL_Min","GLOBAL_Max","DIRECT_Avg","DIRECT_Std",
             ...
             C0500=["day","minute","null_float1", "UVBw_Avg","UVBw_Std","UVBw_Min","UVBw_Max","empy"], 
...
df_aux=df.copy()
df_aux=df_aux[df_aux["TIMESTAMP"].dt.month==int(mounth_)]
df_aux["TIMESTAMP"]=df_aux["TIMESTAMP"] + pd.Timedelta(hours=6)
day = [x.day for x in df_aux["TIMESTAMP"]]
minute = [x.hour*60+x.minute for x in df_aux["TIMESTAMP"]]
month = [x.month for x in df_aux["TIMESTAMP"]]
...
def CreateFinalArchive(df,path_origin=r"..\00 bsrn\fijo.dat",path_destination="Final_Example.dat"):
    ...
    for i in options.keys():
        ...
        if i=="C0100":
            ...
            columns_2=["empy","empy","UVBw_Avg","UVBw_Std","UVBw_Min","UVBw_Max","null_float1","null_float1","null_float1","null_float1",
