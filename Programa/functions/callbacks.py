...
def fcheck(filename):
    ...
    BSRN_fcheck = os.path.join(".", "BSRN_fcheck.exe")

    # fcheck
    print("_"*30)
    print("START BSRN_fcheck")
    print("_"*30)
    result = subprocess.run([BSRN_fcheck, filename], capture_output = True, text = True)
    # Output del fcheck
    print("Standard Output:", result.stdout)
    print("Standard Error:", result.stderr)
    print("_"*30)
    print("END BSRN_fcheck")
    print("_"*30)
