/*
Programname:	F_CHECK.C (v3.4)

Author:		Vlado Nespor
Version:	3.4,  see changelog 

Function:	Checks station-to-archive data files for errors
            in format of metadata and atm. data and writes a report file
...
Contributors:
            Vlado Nespor
            Guido Mueller
            L. Vuilleumier (V3.4, 2022)

Changelog:
v.3.0 -> 3.1 (Unknown date) -- Nespor/Mueller: 
  1) log. records 310 and 330 changed to log. records 3010 and 3030
  2) added log. record 3300

v.3.1 -> 3.2 (Unknown date) -- Nespor/Mueller: 
  1) year check changed to 4 difits

v.3.2 -> 3.3 (01-OCT-2000)  -- Nespor/Mueller:
  1) handels 3-band and 4-band radiation instruments

v.3.3 -> 3.4 (21-FEB-2022)  -- Laurent Vuilleumier:
  1) added checks for record 3010, 3030, 4000, 4010 and 4030
  2) change contacts from ETH to AWI (see f_check_usage function)
...
printf ("   		Amelie Driemel amelie.driemel AT awi.de\n");
//printf (" Note  :	Please report problems, suggestions, etc. to:\n");
