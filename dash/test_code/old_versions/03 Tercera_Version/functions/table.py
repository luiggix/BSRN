...
def create_table(selections,start_date,end_date,time_range=[0,-1],highlight_date=None):
    ...
    Args:
        selections (list o str):        
            ...
            También se puede proporcionar una sola columna como string.
        start_date (str):               
        ...
        time_range (list, opcional):    
            Lista de dos elementos que indica el índice inicial y final de las filas del DataFrame que se 
            quieren mostrar en la tabla. Por defecto, se muestran todas las filas (-1 indica la última fila).
    ...
    table = dash_table.DataTable(
        ...
        data=filtered_dff[time_range[0]:time_range[1]].to_dict("rows"),
        page_size=60,
